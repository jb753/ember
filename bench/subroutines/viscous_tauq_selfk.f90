...
module viscous_selfk_helpers
    implicit none
    private
    public :: load_halo_ijedge
...
end module viscous_selfk_helpers


subroutine set_visc_force_tqf_selfk( &
...
end subroutine set_visc_force_tqf_selfk
