...
.. GENERATED FROM PYTHON SOURCE LINES 35-81
...
.. GENERATED FROM PYTHON SOURCE LINES 165-197
...
.. GENERATED FROM PYTHON SOURCE LINES 281-325
...
.. image-sg:: /auto_examples/images/sphx_glr_run_duct_002.png
   :alt: Meridional mesh at $k=0$ (121 x 65 nodes)
...
.. image-sg:: /auto_examples/images/sphx_glr_run_duct_003.png
   :alt: Energy residual (semilog), Mass flow error, Entropy rise
   :srcset: /auto_examples/images/sphx_glr_run_duct_003.png
   :class: sphx-glr-single-img
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    n_stage=0, cfl=0.4, sf_resid=0.0, fac_mgrid=0.4: 18.6 s, 37.2 ms/step, 0.083 us/node/step
    n_stage=4, cfl=4.0, sf_resid=0.0, fac_mgrid=0.0: 44.9 s, 89.8 ms/step, 0.200 us/node/step
    n_stage=4, cfl=8.0, sf_resid=1.0, fac_mgrid=0.0: 53.6 s, 107.3 ms/step, 0.239 us/node/step
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** (1 minutes 58.724 seconds)
